...
We'll use the phyton script [`replace.py`](../rscript/replace.py).
...
( grep -v ^P hprcy1.pggb.chm13_chr15_66080001-66090000.gfa;
  ...
  |  python ../rscript/replace.py ../../metadata/hprc_superpop.tsv | grep AFR ) \
  >hprcy1.pggb.chm13_chr15_66080001-66090000.AFR.gfa
( grep -v ^P hprcy1.pggb.chm13_chr15_66080001-66090000.gfa;
  grep ^P hprcy1.pggb.chm13_chr15_66080001-66090000.gfa \
  |  python ../rscript/replace.py ../../metadata/hprc_superpop.tsv | grep AMR ) \
